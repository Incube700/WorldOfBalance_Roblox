-- One-time Roblox Studio Command Bar setup for editable Playable Shell stats panel.
...
local panel = getOrCreate(gui, "Frame", "StatsPanel")
...
print("[WOB SHELL] Stats panel UI ready at StarterGui/WOBPlayableShellGui/StatsPanel.")
